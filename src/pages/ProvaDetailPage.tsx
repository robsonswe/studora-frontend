      ...
      <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          <div className="lg:col-span-8 space-y-6">
            <QuestionCard
              concurso={concurso ? { ...concurso, bancaNome: concurso.banca?.nome, instituicaoNome: concurso.instituicao?.nome, instituicaoArea: concurso.instituicao?.area } : undefined}
