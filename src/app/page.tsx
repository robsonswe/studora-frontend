        ...
        <div className="animate-enter-2">
          <div className="bg-indigo-600 rounded-2xl overflow-hidden relative hero-grid">
            ...
            <div className="relative px-5 py-8 sm:px-8 sm:py-12 lg:px-12 flex flex-col md:flex-row md:items-center justify-between gap-6 sm:gap-8">
              ...
              <button
                onClick={() => router.push(`/simulados/${inProgressSimulado.id}`)}
        ...
        <div className="lg:col-span-8 space-y-6 sm:space-y-8 lg:space-y-10">
          ...
          <section className="animate-enter-3">
            <div className="flex items-baseline justify-between mb-4 sm:mb-5">
              ...
              <Link href="/simulados" className="text-sm font-medium text-indigo-600 hover:text-indigo-700 flex items-center gap-1 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2 rounded">
        ...
        <div className="lg:col-span-4 space-y-6 sm:space-y-8">
          ...
          <section className="animate-enter-4">
            ...
            <div className="space-y-2">
              ...
              <Link href="/concursos" className="block text-center text-xs font-medium text-indigo-600 hover:text-indigo-700 pt-2 pb-1 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2 rounded">Ver todas as provas</Link>
            </div>
          </section>
