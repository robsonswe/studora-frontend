    ...
    return (
      <div className="flex flex-wrap gap-x-3 gap-y-1 mt-1.5">
        {['FACIL', 'MEDIA', 'DIFICIL', 'CHUTE'].map(diff => {
          ...
          return (
            <div key={diff} className="flex items-center text-[10px] font-mono font-bold uppercase tracking-tighter">
    ...
    <div className={`flex flex-col border-b border-gray-50 last:border-0 ${level > 0 ? 'bg-gray-50/30' : ''}`}>
      <div className="flex flex-col sm:flex-row sm:items-center justify-between p-4 hover:bg-gray-100/50 transition-colors gap-4">
        ...
        <div className="flex items-center justify-between sm:justify-end gap-6 w-full sm:w-auto">
          <div className="flex flex-col items-end text-[10px] min-w-[60px] font-mono">
            <span className="text-gray-400 font-bold uppercase">Tempo</span>
            <span className="text-gray-700 font-bold">{item.avgTimeSeconds.toFixed(0)}s</span>
          </div>
          
          <div className="flex flex-col items-end min-w-[140px]">
            <div className="flex items-center justify-between w-full mb-1 gap-2">
              <span className={`text-sm font-bold font-mono ${item.masteryScore >= 70 ? 'text-green-600' : item.masteryScore >= 50 ? 'text-yellow-600' : 'text-red-600'}`}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-2xl font-bold font-mono text-gray-900">{currentStreak} Dias</p>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-2xl font-bold font-mono text-gray-900">{((learningRate?.recoveryRate || 0) * 100).toFixed(0)}%</p>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-2xl font-bold font-mono text-gray-900">{totalAnswered}</p>
          </div>
        </div>
      </div>
            ...
            >
              <div className="flex items-center justify-between p-6">
                <div className="flex items-center flex-1 min-w-0 mr-6">
                  <div className="flex-shrink-0 w-10 h-10 bg-indigo-100 rounded-xl flex items-center justify-center mr-4 font-mono font-bold text-indigo-700 text-sm">
                ...
                <div className="flex items-center space-x-8">
                  <div className="hidden md:flex flex-col items-end text-[10px] font-mono">
                    <span className="text-gray-400 font-bold uppercase">Tempo Médio</span>
                    <span className="text-gray-700 font-bold">{disc.avgTimeSeconds.toFixed(0)}s</span>
                  </div>
...
<span className={`text-sm font-black font-mono ${
                    ...
                    <span className="text-xs text-gray-500 mt-1 font-mono font-bold">
