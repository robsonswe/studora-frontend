          ...
          <div className="flex flex-col sm:flex-row items-center gap-4">
            {formStep === 2 && (
              <button
                ...
                className="w-full sm:w-auto px-6 py-2 border border-slate-300 rounded-xl text-xs font-bold text-slate-700 hover:bg-slate-50 transition-all flex items-center justify-center"
              >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="space-y-4">
                  ...
                  <AsyncSelect
                    ...
                    classNamePrefix="react-select"
                    loadingMessage={() => "Carregando..."}
                    noOptionsMessage={() => "Nerhum encontrado"}
                    menuPortalTarget={typeof document !== 'undefined' ? document.body : null}
                  />
                  <div className="space-y-2 max-h-48 overflow-y-auto pr-1 no-scrollbar">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="flex items-center pt-6">
                  <label className="relative inline-flex items-center cursor-pointer group">
                    <input
                      type="checkbox"
                      checked={formData.includeAutoral}
                      onChange={e => setFormData({ ...formData, includeAutoral: e.target.checked })}
                      className="sr-only peer"
                    />
                    <div className="w-11 h-6 bg-slate-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-indigo-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-slate-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-indigo-600"></div>
                    <span className="ml-3 text-sm font-bold text-slate-700 group-hover:text-indigo-600 transition-colors">Incluir questões autorais</span>
                  </label>
                </div>
              </div>
