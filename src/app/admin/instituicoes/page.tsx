...
function InstituicoesContent() {
  ...
  const handleDelete = (id: number) => {
    setConfirmModal({
      ...
      message: 'Tem certeza que deseja excluir esta instituição? Concursos e questões associadas poderão ser afetados e esta ação não pode ser desfeita.',
      itemId: id,
      type: 'danger',
      alertOnly: false
    });
        ...
        <div className="flex flex-col sm:flex-row items-stretch gap-2">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="block w-full pl-9 pr-3 py-2 border border-slate-200 rounded-md text-sm text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all bg-slate-50/30 hover:bg-slate-50"
            />
          </div>
          <div className="flex items-center gap-2">
            {urlNome && (
              <button
                ...
                className="inline-flex items-center justify-center px-3 py-2 border border-slate-200 text-xs font-semibold rounded-md text-slate-600 bg-white hover:bg-slate-50 transition-colors"
              >
                Limpar
              </button>
            )}
            <button
              ...
              className="inline-flex items-center justify-center px-4 py-2 border border-transparent shadow-sm text-xs font-bold rounded-md text-white bg-indigo-600 hover:bg-indigo-700 transition-colors"
            >
              Aplicar Filtro
            </button>
          </div>
                ...
                <div className="px-4 py-3 sm:px-6 flex justify-between items-center gap-4">
                  ...
                  <div className="flex space-x-2 flex-shrink-0">
                    <button
                      ...
                      className="inline-flex items-center px-3 py-1.5 border border-slate-200 text-xs font-bold rounded-md text-slate-700 bg-white hover:bg-slate-50 focus:outline-none transition-colors"
                      disabled={localLoading}
                    >
                      Editar
                    </button>
                    <button
                      ...
                      className="inline-flex items-center px-3 py-1.5 text-xs font-bold rounded-md text-white bg-red-600 hover:bg-red-700 focus:outline-none transition-colors"
                      disabled={localLoading}
                    >
                      Excluir
                    </button>
